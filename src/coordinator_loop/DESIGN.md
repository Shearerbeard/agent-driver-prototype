...
| `WorkerRoster` | A plan may assign work only to a configured worker | A task dispatched to a worker that does not exist, which no later stage could recover from |
